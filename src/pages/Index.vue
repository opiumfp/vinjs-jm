<template>
  <Layout>
    ...
    <div class="layer layer-content">
      ...
      <section
        class="py-7 vjs-bg-logo vjs-bg-logo-red text-white section-vh-100 d-flex align-items-center justify-content-center"
      ...
      <section :id="$page.pageData.mediaTiles.id" class="vjs-bg-logo vjs-bg-logo-green text-white">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <page-title
      ...
      <!-- <section class="position-relative pt-5 pb-5">
        ...
        ></page-title>
        <h5 class="text-center pt-3 pt-lg-4">21.08<span class="font-weight-normal"> - VinnytsiaJS 2021 - Open Air Conference</span></h5>
    ...
    <telegram-widget channel="vinjs" postid="141"></telegram-widget>
